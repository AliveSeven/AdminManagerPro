                    ...
                    <el-form :model="ruleForm" status-icon :rules="rules" class="demo-ruleForm">
                        ...
                        <div class="form-item-input">
                            <el-form-item label="" prop="user">
                                <el-input type="text" size="large" :prefix-icon="User" v-model="ruleForm.username"
                                    placeholder="请输入用户名" autocomplete="off"></el-input>
                            </el-form-item>
                            <el-form-item label="" prop="pass">
                                <el-input type="password" size="large" :prefix-icon="Lock" v-model="ruleForm.password"
